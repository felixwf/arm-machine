...
#define STEPPER_COM_TX_GPIO_CLK     RCC_APB2Periph_GPIOA     //UART TX
#define STEPPER_COM_TX_PIN          GPIO_Pin_2
#define STEPPER_COM_TX_GPIO_PORT    GPIOA
#define STEPPER_COM_RX_GPIO_CLK     RCC_APB2Periph_GPIOA     //UART RX
#define STEPPER_COM_RX_PIN          GPIO_Pin_3
#define STEPPER_COM_RX_GPIO_PORT    GPIOA
#define STEPPER_COM_IRQn            USART3_IRQn
#define STEPPER_COM_Priority        10                       //优先级
