#include "status_machine_app.h"


StatusManager_TypeDef StatusManager;


static void StatusManager_App_Task(void *pvParameters);
TaskHandle_t StatusManager_App_Task_Handler;
/* �궨�� --------------------------------------------------------------------*/
#define STATUSMANAGER_STACK_SIZE        128                      //CANOPEN�����ջ��С
#define STATUSMANAGER_TASK_PRIORITY     3                        //CANOPEN�������ȼ�
